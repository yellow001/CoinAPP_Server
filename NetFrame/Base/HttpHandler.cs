...
namespace CoinAPP_Server.NetFrame.Base
{
    public class HttpHandler
    {
        HttpListener httpobj;

        SpotHandleInterface spotHandle;


        public HttpHandler(SpotHandleInterface handle, string url) {
        ...
        private void Result(IAsyncResult ar)
        {
            ...
            returnObj = spotHandle.GetResult();
